...
session_start();
if (empty($_SESSION['admin_id'])) { header('Location: ' . dirname(dirname($_SERVER['SCRIPT_NAME'])) . '/admin/login.php'); exit; }
...
<div class="container">
  ...
  <hr>
  <a class="btn btn-sm btn-primary" href="<?php echo dirname(dirname($_SERVER['SCRIPT_NAME'])); ?>/admin/manage_faq.php">Kelola FAQ</a>
  <a class="btn btn-sm btn-secondary" href="<?php echo dirname(dirname($_SERVER['SCRIPT_NAME'])); ?>/admin/manage_faq.php?view=unanswered">Lihat Unanswered</a>
  <a class="btn btn-sm btn-outline-danger" href="<?php echo dirname(dirname($_SERVER['SCRIPT_NAME'])); ?>/admin/logout.php">Logout</a>
</div>
</body></html>