...
<head>
  ...
  <link href="/chatbot/public/assets/styles.css" rel="stylesheet">
</head>
...
<nav class="navbar navbar-expand-lg navbar-white bg-white shadow-sm mb-4">
  <div class="container">
    <a class="navbar-brand d-flex align-items-center gap-2" href="/chatbot/public/index.php">
    ...
    <div class="collapse navbar-collapse" id="navMain">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center">
        <li class="nav-item"><a class="nav-link" href="/chatbot/public/chat.php">Chat</a></li>
        <li class="nav-item"><a class="nav-link" href="#">Tentang</a></li>
        <li class="nav-item"><a class="nav-link" href="#">Kontak</a></li>
        <li class="nav-item ms-2"><a class="btn btn-sm btn-outline-primary" href="/chatbot/admin/login.php">Admin</a></li>
      </ul>
    </div>
  </div>
</nav>
