    ...
    <div class="chatbox">
        <div class="chat-header">
            <div class="bot-identity">
                <div class="bot-avatar" style="background-image: url('/Chatbot/images/bot.png.png'); background-size: cover; background-position: center;"></div>
                <div class="bot-info">
...
function kirim() {
    ...
    typingMsg.innerHTML = "<img src='/Chatbot/images/bot.png.png' class='message-avatar' alt='Bot'><div class='message-content typing-dots'><span></span><span></span><span></span></div>";
    ...
    .then(data => {
        ...
        botMsg.innerHTML = "<img src='/Chatbot/images/bot.png.png' class='message-avatar' alt='Bot'><div class='message-content' id='" + contentId + "'></div>";
    ...
    .catch(error => {
        ...
        errMsg.innerHTML = "<img src='/Chatbot/images/bot.png.png' class='message-avatar' alt='Bot'><div class='message-content'>❌ Error: " + escapeHtml(error) + "</div>";
